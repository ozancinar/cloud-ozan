...
An online service to generate a virtual human population. Note that the service has been retired.
...
<script type="application/ld+json">
{
  ...
  "name": "PopGen", 
  "description": "An online service to generate a virtual human population. Note that the service has been retired.",
